...
本项目是基于另一项目[MACC](https://github.com/mxia9416/MACC) 而诞生的，MACC作者太久未更新且无渠道联系，故本人自行编写了本项目，开发过程有参考MACC。
本人纯新手，不会代码，使用纯 Pipeline 低代码编写，欢迎大佬指导。
该项目为我在周末慢慢编写，所以随缘更新了，一般我自己遇到的bug都会修复，大家及时更新就行。

## 功能介绍

目前已有的功能：

- 启动游戏:<br>关闭广告/禁闭者情绪检测
- 秘盟捐赠
- 好友点数
- 监管奖励
- 领取免费礼包
...
- 领取体力
- 扫荡浊暗之阱
- 清体力:<br> 记忆风暴/淘金狂热/恶兆之种/极域搜寻/禁区探查/帕尔马废墟
- 领取监察密令奖励
